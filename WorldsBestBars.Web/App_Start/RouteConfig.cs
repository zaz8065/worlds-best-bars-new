...
namespace WorldsBestBars.Web
{
    public class RouteConfig
    {
        private static void RegisterStaticRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("User - Profile - Update", "profile/update", new { controller = "User", action = "UpdateProfile" }, new string[] { "WorldsBestBars.Web.Controllers" });
            routes.MapRoute("User - Profile", "profile", new { controller = "User", action = "DisplayProfile" }, new string[] { "WorldsBestBars.Web.Controllers" });
